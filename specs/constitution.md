...
## 1. Tech Stack (IMMUTABLE — do not change without constitution amendment)
...
- Displayed as: `«۲ میلیارد و ۷۰۰ میلیون تومان»`
...
- **Celery**: every external or long-running task (SMS, AI, publish, render, import) — no exceptions
...
- Commit message: `<type>(<scope>): <subject>` (Conventional Commits)
  ...
  - Subject: English, imperative, lowercase, no period, ≤72 chars
...
Per constitution §8 of original spec: always read official docs before implementing any external service (SMS, Telegram, Bale, Rubika, Instagram, Gemini). Never guess endpoints or parameter names from memory.
