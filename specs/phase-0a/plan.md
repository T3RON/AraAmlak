...
**Phase 0A adds:**
1. `.env.example` — complete with all required vars
2. `Makefile` — all 7 targets
3. `/health` view + URL
4. `config/` → renamed to `ara_amlak/settings/` (already exists)
...
- View in `apps/core/views.py` — returns JSON
