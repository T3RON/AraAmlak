# Spec ظ¤ Phase 0A: Full Scaffold & Dev Infrastructure

## Scope
Complete the project skeleton for **Ara Amlak** with a production-ready developer workflow:

1. One-command startup (`make up`) ظ¤ web, db, redis, celery, celery-beat, channels
...
### FR-3  Homepage
`GET /` ظْ HTML page: RTL, `lang="fa"`, title and h1 = "╪ت╪▒╪د ╪د┘à┘╪د┌ر", brief description.
...
See `specs/constitution.md` ظ¤ this is the authoritative reference for all phases.
